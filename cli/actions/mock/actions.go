...
import (
	...
	commands "github.com/NethermindEth/sedge/internal/pkg/commands"
...
// GetCommandRunner mocks base method.
func (m *MockSedgeActions) GetCommandRunner() commands.CommandRunner {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetCommandRunner")
	ret0, _ := ret[0].(commands.CommandRunner)
	return ret0
}

// GetCommandRunner indicates an expected call of GetCommandRunner.
func (mr *MockSedgeActionsMockRecorder) GetCommandRunner() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCommandRunner", reflect.TypeOf((*MockSedgeActions)(nil).GetCommandRunner))
}
