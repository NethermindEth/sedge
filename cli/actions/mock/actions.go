...
// ImportValidatorKeys mocks base method.
func (m *MockSedgeActions) ImportValidatorKeys(arg0 actions.ImportValidatorKeysOptions) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ImportValidatorKeys", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}

// ImportValidatorKeys indicates an expected call of ImportValidatorKeys.
func (mr *MockSedgeActionsMockRecorder) ImportValidatorKeys(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ImportValidatorKeys", reflect.TypeOf((*MockSedgeActions)(nil).ImportValidatorKeys), arg0)
}
