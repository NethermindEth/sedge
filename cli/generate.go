...
`,
	...
	cmd.PersistentFlags().StringVarP(&network, "network", "n", "mainnet", "Target network. e.g. mainnet,sepolia, holesky, gnosis, chiado, volta, energyweb, joc-mainnet, joc-testnet, linea-mainnet, linea-sepolia, xdc, xdc-testnet etc.")
