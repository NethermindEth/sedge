...
# Set up Obol DV Node with Sedge 

## What is the Obol DVT in a Nutshell?

**[Read more about Obol DVT here](https://dvt.obol.tech/)**

Sedge supports DV Node setup, by allowing users to set up their full nodes with ease. This guide
will walk you through the process of setting up Obol DV node using Sedge.

:::info

Read more about how to generate **[Distributed Validator keys](https://docs.obol.org/docs/next/start/quickstart_group)**.

:::

## Workflow breakdown

The Obol DV Setup process involves few steps:
...
Once the Keys import process is complete **sedge-data** folder contents will be updated.
