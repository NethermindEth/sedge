...
files to another machine. Currently, Sedge runs the docker compose stack that was just generated using `sedge run`. You
...
files under the `sedge-data` directory will be overwritten.
