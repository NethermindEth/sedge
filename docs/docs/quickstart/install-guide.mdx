...
<Tabs groupId="download-cmds">
  ...
  ```
  curl -OL https://github.com/NethermindEth/sedge/releases/download/v<VERSION>/sedge-v<VERSION>-<OS>-<ARCH>
  ```

  </TabItem>
  <TabItem value="wget" label="wget">

    wget https://github.com/NethermindEth/sedge/releases/download/v<VERSION>/sedge-v<VERSION>-<OS>-<ARCH>
