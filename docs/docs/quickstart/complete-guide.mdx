...
<Tabs groupId="download-cmds">
  ...
  ```
  curl -L https://github.com/NethermindEth/sedge/releases/download/v1.7.3/sedge-v1.7.3-linux-amd64 --output sedge
  ```
  ...
  ```
  wget https://github.com/NethermindEth/sedge/releases/download/v1.7.3/sedge-v1.7.3-linux-amd64 -O sedge
  ```
