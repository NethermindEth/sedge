...
<Tabs groupId="download-cmds">
  ...
  ```
  curl -L https://github.com/NethermindEth/sedge/releases/download/v1.1.0/sedge-v1.2.2-linux-amd64 --output sedge
  ```
  ...
  ```
  wget https://github.com/NethermindEth/sedge/releases/download/v1.1.0/sedge-v1.2.2-linux-amd64 -O sedge
  ```
