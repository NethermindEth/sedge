...
<Tabs groupId="download-cmds">
  ...
  ```
  curl -L https://github.com/NethermindEth/sedge/releases/download/v1.9.0/sedge-v1.9.0-linux-amd64 --output sedge
  ```
  ...
  ```
  wget https://github.com/NethermindEth/sedge/releases/download/v1.9.0/sedge-v1.9.0-linux-amd64 -O sedge
  ```
