...
(we will be using the `1.2.0` version). Check the [installation guide](install-guide) for more information or if you
...
<Tabs groupId="download-cmds">
  ...
  ```
  wget https://github.com/NethermindEth/sedge/releases/download/v1.2.0/sedge-v1.2.0-linux-amd64 -O sedge
  ```
