...
Flags:
      --colour bool                     Enable colored log.
      --db-path string                  Path to the database.
      --eth-node string                 Websocket endpoint of the Ethereum node used to verify the L2 chain. If using Infura, it looks something like `wss://mainnet.infura.io/ws/v3/your-infura-project-id`'"
      --http string                     Enables the HTTP RPC server.
      --http-host string                Interface on which the HTTP RPC server will listen for request.
      --http-port string                Port on which the HTTP RPC server will listen for request.
      --ws bool                         Websocket RPC server.
      --ws-host string                  Interface on which the Websocket RPC server will listen for request.
      --ws-port string                  Port on which the Websocket RPC server will listen for request.
      --pprof bool                      Pprof server
      --pprof-host string               Interface on which the pprof RPC server will listen for request.
      --pprof-port string               Port on which the pprof RPC server will listen for request.
      --metrics bool                    Metrics server.
      --metrics-host string             Interface on which the metrics server will listen for request.
      --metrics-port string             Port on which the metrics RPC server will listen for request.
      --grpc bool                       Grpc server.
      --grpc-host string                Interface on which the grpc server will listen for request.
      --grpc-port string                Port on which the grpc server will listen for request.
      --log-level string                Options: debug, info, warn, error.
      --network string                  Options: mainnet, goerli, goerli2, integration.
      ...
      --p2p bool                        Enable the p2p server.
      --p2p-addr string                 Source address.
      --p2p-boot-peers string           Boot nodes.
