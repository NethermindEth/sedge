...
Flags:
  ...
  -p, --path string            docker-compose scripts generation path (default "./docker-compose-scripts")
      --services stringArray   List of services to run. If this flag is not provided, all services will run.
...
# highlight-next-line
2022-12-29 19:55:55 -- [DEBU] Running command: docker compose -f docker-compose-scripts/docker-compose.yml build
2022-12-29 19:55:55 -- [DEBU] Running command with sudo.
# highlight-next-line
2022-12-29 19:55:55 -- [DEBU] Running command: docker compose -f docker-compose-scripts/docker-compose.yml pull
2022-12-29 19:55:55 -- [DEBU] Running command with sudo.
[+] Running 5/5
...
# highlight-next-line
2022-12-29 19:55:56 -- [DEBU] Running command: docker compose -f docker-compose-scripts/docker-compose.yml create
...
# highlight-next-line
2022-12-29 19:55:56 -- [DEBU] Running command: docker compose -f docker-compose-scripts/docker-compose.yml up -d
2022-12-29 19:55:56 -- [DEBU] Running command with sudo.
[+] Running 2/4
...
# highlight-next-line
2022-12-29 21:03:29 -- [DEBU] Running command: docker compose -f docker-compose-scripts/docker-compose.yml build execution consensus
2022-12-29 21:03:29 -- [DEBU] Running command with sudo.
# highlight-next-line
2022-12-29 21:03:29 -- [DEBU] Running command: docker compose -f docker-compose-scripts/docker-compose.yml pull execution consensus
2022-12-29 21:03:29 -- [DEBU] Running command with sudo.
[+] Running 2/2
 ⠿ execution Pulled 0.2s
 ⠿ consensus Pulled 0.4s
# highlight-next-line
2022-12-29 21:03:30 -- [DEBU] Running command: docker compose -f docker-compose-scripts/docker-compose.yml create execution consensus
...
[+] Running 4/2
 ...
 ⠿ Container execution-client              Created  0.1s
# highlight-next-line
2022-12-29 21:03:30 -- [DEBU] Running command: docker compose -f docker-compose-scripts/docker-compose.yml up -d execution consensus
2022-12-29 21:03:30 -- [DEBU] Running command with sudo.
[+] Running 2/2
...
# highlight-next-line
2022-12-29 21:24:12 -- [DEBU] Running command: docker compose -f docker-compose-scripts/docker-compose.yml build validator
2022-12-29 21:24:12 -- [DEBU] Running command with sudo.
# highlight-next-line
2022-12-29 21:24:12 -- [DEBU] Running command: docker compose -f docker-compose-scripts/docker-compose.yml pull validator
2022-12-29 21:24:12 -- [DEBU] Running command with sudo.
[+] Running 1/1
 ⠿ validator Pulled 0.2s
# highlight-next-line
2022-12-29 21:24:12 -- [DEBU] Running command: docker compose -f docker-compose-scripts/docker-compose.yml create validator
2022-12-29 21:24:12 -- [DEBU] Running command with sudo.
[+] Running 4/3
 ...
 ⠿ Container validator-client                            Created  0.0s
# highlight-next-line
2022-12-29 21:24:13 -- [DEBU] Running command: docker compose -f docker-compose-scripts/docker-compose.yml up -d validator
