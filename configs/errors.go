...
const (
	...
	InvalidWithdrawalAddrError           = "provided withdrawal address is not a valid Ethereum address"
	...
	WithdrawalBLSSecretKeyCreationError  = "failed to create withdrawal private key for path %q: %v"
	WithdrawalEth1SecretKeyCreationError = "failed to create withdrawal private key for address 0x%s: %v"
