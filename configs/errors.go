...
const (
	...
	IncorrectClientError        = "incorrect client name %s. Please provide correct client name. Use 'listClient' command to see the list of supported clients"
	NoClientsFoundError         = "no %s clients found. Please check your configuration file"
	ClientNotSpecifiedError     = "%s client not specified"
