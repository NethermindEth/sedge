...
var networksConfigs map[string]NetworkConfig = map[string]NetworkConfig{
	...
	NetworkChiado: {
		...
		DefaultCustomConfigSrc: "https://github.com/gnosischain/configs/tree/main/chiado",
		DefaultCCBootnodes: []string{
	...
	NetworkCustom: {
		...
		RequireJWT:         true,
		NetworkService:     "merge",
		GenesisForkVersion: "0x00000000", // FIXME: only affects keystores generation, ensure the deposit method does not conflict over this.
	},
}
