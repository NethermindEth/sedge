...
Follow https://launchpad.ethereum.org/ and happy staking!`
	...
	ExposePortsWarning              = "You are using exposed ports for the clients!!! Make sure this is intended. This could make the clients vulnerable to attacks. To avoid this be sure to setup a firewall."
)
